...
use App\Component\Tip\Application\Plugin\UserPastTips;
use App\DataTransferObject\RankingAllEventDataProvider;
use PHPUnit\Framework\TestCase;

class UserPastTipsTest extends TestCase
{
    public function testUserPastTips()
    {
        $rankingAllEventDataProvider = $this->getRankingAllEventDataProvider();
        $userPastTips = new UserPastTips();
        ...
        self::assertSame('user:ninja:past_tips', $redisDto[0]->getKey());
        ...
        self::assertSame($matchId, $tips[1]->getMatchId());
        self::assertSame($matchDatetime, $tips[1]->getMatchDatetime());
        self::assertSame(1, $tips[1]->getTipTeam1());
        self::assertSame(3, $tips[1]->getTipTeam2());
        self::assertNull($tips[1]->getScoreTeam1());
        self::assertNull($tips[1]->getScoreTeam2());
        self::assertSame('PL', $tips[1]->getTeam1());
        self::assertSame('IT', $tips[1]->getTeam2());


        self::assertSame('user:rockstar:past_tips', $redisDto[1]->getKey());
